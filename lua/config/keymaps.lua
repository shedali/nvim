...
vim.api.nvim_set_keymap('n', '<leader>twr', "<cmd>lua require('neotest').run.run({ vitestCommand = 'pnpm vitest --watch' })<cr>", { desc = 'Run Watch' })

vim.api.nvim_set_keymap('n', '<leader>tr', "<cmd>lua require('neotest').run.run({ vitestCommand = 'pnpm vitest run' })<cr>", { desc = 'Run test' })
