...
vim.keymap.set("n", "<leader>gm", function() require("gitsigns").change_base("main", true) end, { silent = true, noremap = true, desc = "Gitsigns diff against main" })
vim.keymap.set("n", "<leader>gM", function() require("gitsigns").reset_base(true) end, { silent = true, noremap = true, desc = "Gitsigns reset to index" })
vim.keymap.set("n", "<leader>gf", "<cmd>DiffviewOpen main<cr>", { silent = true, noremap = true, desc = "Diffview files vs main" })
vim.keymap.set("n", "<leader>gF", "<cmd>DiffviewClose<cr>", { silent = true, noremap = true, desc = "Diffview close" })
